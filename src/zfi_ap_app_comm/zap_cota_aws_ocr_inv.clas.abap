class ZAP_COTA_AWS_OCR_INV definition
  public
...
private section.
  ...
  constants CID type CL_COMMUNICATION_TARGET_ROOT=>NAME_TYPE value 'ZAP_COTA_AWS_OCR_INV' ##NO_TEXT.
  ...
  constants Ccreated_by_cota type CL_COMMUNICATION_TARGET_ROOT=>NAME_TYPE value 'ZAP_COTA_AWS_OCR_INV' ##NO_TEXT.
ENDCLASS.



CLASS ZAP_COTA_AWS_OCR_INV IMPLEMENTATION.
  ...
  SUPER->constructor(
    EXPORTING
      ...
      SECKEY = CONV int8( '8934560705543279330-' )
